...
public class UserUI extends JFrame {
    ...
    public UserUI(DatabaseService dbService, UserService userService) {
        ...
        JButton resetDbButton = new JButton("Очистить БД");
        buttonPanel.add(resetDbButton);
    ...
    private void createUsers() {
        ...
        users = userService.generateUsers();

        for (User user : users) {
            dbService.saveUser(user, "User");
        ...
        JOptionPane.showMessageDialog(this, "Пользователи созданы и сохранены в БД");
    }
